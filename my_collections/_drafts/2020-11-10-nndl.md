...
<img src="/images/nndl/SmallChanges.svg" width="250" alt="Neuron with inputs, weights" /> 
...
<img src="/images/nndl/NAND.svg" width="250" alt="Neuron as NAND" />
...
<img src="/images/nndl/SmallChanges.svg" width="250" alt="neuural network + small changes" />
...
<img src="/images/nndl/Sigmoid.svg" width="600" alt="sigmoid" />


### Neural Network arrangement
 
<img src="/images/nndl/Hidden.svg" width="400" alt="network with input, hidden & output layers" />
...
```
Pro Tip: If we can move with step sizes proportional to the slope, as the slope flattens out towards minimum the steps become smaller. This  helps to avoid over shooting off the minima. 

What if it's a surface? (2D or more)
We need direction & magnitude to take the next step that decreases output most quickly. 

Direction = 
because Gradient of a function gives direction of steepest ascent (#calculus)
Length = 
indicator of how steep the path is
